...
testData = readjson.readJson().read_json("term_template/create_term_template_script.json")
...
class testCreateTermTpl(unittest.TestCase):
    ...
    def checkResult(self):# 断言
        ...
        :return:
        """
        url = geturlParams.geturlParams().get_Url("term-tpls")  # 调用我们的geturlParams获取我们拼接的URL
...
if __name__ == "__main__":
    testCreateTermTpl().test_create_term_tpl()
