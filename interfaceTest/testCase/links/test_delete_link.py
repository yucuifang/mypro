...
testData = readjson.readJson().read_json("links/delete_links_script.json")
...
class testDeleteLink(unittest.TestCase):
    ...
    def setUp(self):
        ...
        :return:
        """
        log.info("testDeleteLink 测试开始前准备")
    ...
    def tearDown(self):
        log.info("testDeleteLink 测试结束，输出log完结")
    ...
    def checkResult(self):# 断言
        ...
        for data in testData:
            ...
            info = RunMain().run_main("delete", url, data)  # 调用run_main来进行requests请求，并拿到响应
...
if __name__ == "__main__":
    testDeleteLink().test_delete_link()
