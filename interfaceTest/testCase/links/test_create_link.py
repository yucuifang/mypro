...
testData = readjson.readJson().read_json("links/create_links_script.json")
...
class testCreateLink(unittest.TestCase):
    ...
    def setUp(self):
        ...
        :return:
        """
        log.info("testCreateLink 测试开始前准备")
    ...
    def tearDown(self):
        log.info("testCreateLink 测试结束，输出log完结")
    ...
    def checkResult(self):# 断言
        ...
        :return:
        """
        url = geturlParams.geturlParams().get_Url("links")  # 调用我们的geturlParams获取我们拼接的URL
...
if __name__ == "__main__":
    testCreateLink().test_create_link()
